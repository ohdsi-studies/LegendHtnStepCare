...
LegendHtnStepCare:::printCohortDefinitionFromNameAndJson(name = "Class-vs-Class Exposure (ACEI after Thiazide) Cohort / OT1 {#class-cohort}", json = baseCohortJson$json)
```
